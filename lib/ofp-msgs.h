...
enum ofptype {
    ...
    OFPTYPE_FLOW_MONITOR_REQUEST, /* OFPRAW_OFPST14_FLOW_MONITOR_REQUEST. */
    OFPTYPE_FLOW_MONITOR_REPLY, /* OFPRAW_OFPST14_FLOW_MONITOR_REPLY. */

    /* NSX Flow monitor extension. */
